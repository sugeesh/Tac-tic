...
public class Board extends javax.swing.JFrame {
    ...
    public static void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (playerTurn) {
            jButton2.setText("X");
            ob.checkForWins();
            playerTurn = false;
    ...
    public static void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        if (playerTurn) {
            jButton8.setText("X");
            ob.checkForWins();
            playerTurn = false;
